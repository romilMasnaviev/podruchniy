...
VALUES (4.5, 'Тихое место ! Большой выбор блюд и напитков.', 1, 2),
     (4.0, 'Приятное заведение, большой выбор блюд. Тихое место ', 1, 3); -- Ещё один отзыв для Ресторана "Под липами"
    -- (4.2, 'Хорошее кафе, недалеко от пруда.', 1, 4); -- Ресторан "Под липами", отзыв от пользователя 2
--     (4.0, 'Бар на пляже с шикарным видом.', 3, 3, 3); -- Ресторан "Под липами", отзыв от пользователя 3
